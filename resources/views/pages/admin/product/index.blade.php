          ...
          <div class="section-content section-dashboard-home" data-aos="fade-up">
            <div class="container-fluid">
              <div class="dashboard-heading">
                ...
                <p class="mb-4 text-base text-gray-900 dark:text-white">List of Product</p>
              </div>
    ...
    <script>
        var datatable = $('#crudTable').DataTable({
            ...
            columns: [
                ...
                {data: 'price', name: 'price', className: 'px-6 py-4' },
                {data: 'category.name', name: 'category.name', className: 'px-6 py-4' },
                {
                    data: 'action',
                    name: 'action', 
                    className: 'px-6 py-4',
