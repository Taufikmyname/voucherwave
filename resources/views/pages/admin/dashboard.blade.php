    ...
    <div class="py-8 px-4 mx-auto max-w-7xl">
      <div class="space-y-6">
          <div>
              ...
              <p class="mt-2 text-gray-600 dark:text-gray-300">This is Voucher Wave Administrator Panel</p>
          </div>
                      ...
                      <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                          ...
                          <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                              ...
                              <td class="px-6 py-4 whitespace-nowrap text-right">
                                  <a href="{{ route('admin-transaction-details', $transaction->id) }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"> 
